...
#       LDAP        #
#####################
AUTH_LDAP_SERVER_URI = env('SENTRY_AUTH_LDAP_SERVER_URI')                      # 'ldap://ldap.ad.com:389'
AUTH_LDAP_BIND_DN = env('SENTRY_AUTH_LDAP_BIND_DN')                         # 'CN=Sentry,OU=SystemUsers,OU=Users,DC=ad,DC=com'
AUTH_LDAP_BIND_PASSWORD = env('SENTRY_AUTH_LDAP_BIND_PASSWORD')             # RandomPass123!

AUTH_LDAP_USER_SEARCH = LDAPSearch(
    env('SENTRY_AUTH_LDAP_USER_SEARCH'),                                           # 'OU=Users,dc=ad,dc=com'
    ldap.SCOPE_SUBTREE,
    '(sAMAccountName=%(user)s)'
)

AUTH_LDAP_GROUP_SEARCH = LDAPSearch(
    env('SENTRY_AUTH_LDAP_GROUP_SEARCH'),                                       # 'OU=Groups,DC=ad,DC=com'
    ldap.SCOPE_SUBTREE,
    '(objectClass=group)'
)
...
AUTH_LDAP_REQUIRE_GROUP = env('SENTRY_AUTH_LDAP_REQUIRE_GROUP')              # "CN=SentryAccess,OU=Groups,DC=ad,DC=com"
